...
namespace CanhCam.Data
{
    public class DBKLAuthor
    {
        ...
        int authorID)
        {
            SqlParameterHelper sph = new SqlParameterHelper(ConnectionString.GetReadConnectionString(), "gb_KLAuthor_SelectOneByUserID", 1);
            sph.DefineSqlParameter("@UserID", SqlDbType.Int, ParameterDirection.Input, authorID);
            return sph.ExecuteReader();
        ...
        public static IDataReader GetPageIsActive(
            int pageNumber,
            int pageSize,
            out int totalPages)
        {
            ...
            SqlParameterHelper sph = new SqlParameterHelper(ConnectionString.GetReadConnectionString(), "gb_KLAuthor_SelectPageForIsActive", 2);
            sph.DefineSqlParameter("@PageNumber", SqlDbType.Int, ParameterDirection.Input, pageNumber);
            sph.DefineSqlParameter("@PageSize", SqlDbType.Int, ParameterDirection.Input, pageSize);
            return sph.ExecuteReader();
