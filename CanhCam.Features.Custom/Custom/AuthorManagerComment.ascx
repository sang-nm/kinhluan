<%@ Control Language="c#" AutoEventWireup="false" CodeBehind="AuthorManagerComment.ascx.cs" Inherits="CanhCam.Web.CustomUI.AuthorManagerComment" %>
        ...
        <div class="col-xs-12 col-lg-9">
            <section class="user-page clearfix">
                <div class="post-title-wrap clearfix">
                    <h1 class="postname">Manage Comment</h1>
                </div>
                <div class="row flex flex-wrap">
                    <div class="col-xs-12">
                        <div class="form-editor" runat="server" id="divfillter">
                            <div class="form-group">
                                <label>Articles: </label>
                                <asp:DropDownList ID="ddlnew" runat="server" DataTextField="Title" DataValueField="NewsID" AutoPostBack="true" >
                                        ...
                                        <div class="comment-item">
                                            <figure class="row flex flex-wrap">
                                                <div class="col-xs-12 col-md-2">
                                                    ...
                                                    <div class="item-name"><%# Eval("Name").ToString() %></div>
                                                </div>
