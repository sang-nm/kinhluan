                                ...
                                <MasterTableView DataKeyNames="NewsID" AllowFilteringByColumn="false">
                                    ...
                                    <%# Eval("Title") %>
                                        ...
                                        <telerik:GridTemplateColumn HeaderText="<%$Resources:CustomResources, Comments %>">
                                            <ItemTemplate>
                                                <i class="fa fa-comments" aria-hidden="true"></i><span><%# getcommentcount(Convert.ToInt32(Eval("NewsID").ToString()))%></span><a href="/manage-comment?NewID=<%# Eval("NewsID") %>" class="comment-link" style="color: white">See</a>
