    ...
    <div class="container">
        <div class="row">
                        ...
                        <div class="maincomment">
                            <div class="maincommentinfo">
                                ...
                                <div class="journalInfo">
                                    <asp:TextBox runat="server" ID="txtFullName" class="txtFullName" placeholder="Your Name (*)" type="text" />
            ...
            <div class="rptcomment">
                <asp:Repeater ID="rptCommentTop" runat="server" OnItemCommand="rptComments_ItemCommand" OnItemDataBound="rptChildComments_ItemDataBound">
                    <ItemTemplate>
                                    ...
                                    <div class="divsubcomment col-sm-12">
                                        ...
                                        <asp:UpdatePanel runat="server">
                                            <ContentTemplate>
                                                ...
                                                <div class="cmtinfo">
                                                    <asp:TextBox runat="server" type="text" class="cmtname" placeholder="Your Name (*)" ID="txtsubname" MaxLength="100" />
