<%@ Control Language="C#" AutoEventWireup="false" CodeBehind="CartList.ascx.cs" Inherits="CanhCam.Web.ProductUI.CartList" %>
    ...
    <ItemTemplate>
        <tr>
            ...
            <td class="cartactions">
                <asp:Button ID="btnUpdateQuantity" runat="server" Text='<%# Resources.WebStoreResources.UpdateQuantityButton %>' CommandName="updateQuantity" CommandArgument='<%# Eval("ItemGuid") %>' CausesValidation="false" CssClass="cartbutton" />
                <asp:Button ID="btnDelete" runat="server" CssClass="cartbutton" CommandArgument='<%# Eval("ItemGuid") %>'
