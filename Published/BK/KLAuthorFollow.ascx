<%@ Control Language="c#" AutoEventWireup="false" CodeBehind="KLAuthorFollow.ascx.cs" Inherits="CanhCam.Web.CustomUI.KLAuthorFollow" %>
        ...
        <div class="col-xs-12 col-lg-9">
            <section class="user-page clearfix">
                <div class="post-title-wrap clearfix">
                    <h1 class="postname">Author Follows</h1>
                </div>
                <div class="row flex flex-wrap">
                    <div class="col-xs-12">
